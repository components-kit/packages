  ...
  return (
    <div className="mt-10 grid gap-3 sm:gap-4 sm:grid-cols-2 lg:grid-cols-3">
      {componentShowcaseRegistry.map((demo) => {
        const card = (
          <div className="min-w-0 flex flex-col rounded-lg bg-neutral-100 overflow-hidden">
            <div className="p-1.5 pb-0 sm:p-2 sm:pb-0">
              <div
                className="flex h-36 sm:h-44 items-center justify-center p-4 sm:p-6 pointer-events-none rounded-md bg-neutral-0 overflow-hidden"
              >
                {demo.preview}
              </div>
            </div>
